# Generated by Django 3.1.3 on 2022-11-11 06:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice', models.CharField(default='first question', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question', models.CharField(default='first question', max_length=200)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.course')),
            ],
        ),
        migrations.CreateModel(
